...
export default function AdminPage() {
  ...
  async function fetchPemilih() {
    const { data, error } = await supabase.from('data_pemilih').select('*');
    ...
    <div className='min-h-screen flex flex-col items-center overflow-hidden bg-gray-50'>
      ...
      <div className='flex flex-1'>
        <div className='mr-4'>
          ...
          <div className='w-full max-w-3xl bg-white p-6 rounded-lg shadow-lg mb-4 border-t-4 border-green-400'>
          ...
          <div className='w-full max-w-3xl bg-white p-6 rounded-lg shadow-lg border-t-4 border-green-400'>
            <h2 className='text-xl font-semibold mb-4 text-gray-700'>
              Sudah terverifikasi
            </h2>
        ...
        <div>
          ...
          <div className='w-full max-w-md bg-white p-6 rounded-lg shadow-lg border-t-4 border-green-400'>
            <h2 className='text-xl font-semibold mb-4 text-gray-700'>
              Daftar Pemilih
            </h2>
